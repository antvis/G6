  ...
  function coordsCharInner(cm, lineObj, lineNo, x, y) {
    ...
    if (order) {
      ...
      outer: do {
        ...
        diff != 0 &&
        (steps > 1 || (dir < 0 != diff < 0 && Math.abs(diff) <= Math.abs(prevDiff)))
      );
...
(function(mod) {
  ...
  var data = {
    a: {
      attrs: { href: null, ping: null, type: null, media: media, target: targets, hreflang: langs },
    },
    abbr: s,
    acronym: s,
    address: s,
