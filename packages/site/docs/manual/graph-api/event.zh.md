...
| 参数      | 类型               | 必填 | 描述                                 |
| --------- | ------------------ | ---- | ------------------------------------ |
| eventName | string             | 是   | 要监听的事件名称（推荐使用常量枚举） |
| callback  | (event: T) => void | 是   | 事件触发时执行的回调函数             |
| once      | boolean            | 否   | 是否只监听一次，默认为 false         |
...
| 参数      | 类型   | 必填 | 描述                         |
| --------- | ------ | ---- | ---------------------------- |
| eventName | string | 是   | 事件名称（推荐使用常量枚举） |
...
| --------- | ------------------------ | ---- | ---------------------------- |
| eventName | string                   | 是   | 事件名称（推荐使用常量枚举） |
| callback  | (...args: any[]) => void | 是   | 要移除的回调函数             |
