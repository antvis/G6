...
| labelFontFamily               | 边标签文字字体族                                                                                                                                                                                                                           | string                                                                            | -          |
...
| badgeBackgroundRadius         | 边徽标背景圆角半径 <br> - number: 统一设置四个圆角半径 <br> - number[]: 分别设置四个圆角半径，会补足缺省的分量 <br> - string: 与 [CSS padding](https://developer.mozilla.org/zh-CN/docs/Web/CSS/padding) 属性类似，使用空格分隔 | number &#124; number[] &#124; string                                                            | 0            |
...
| badgeFontSize                 | 边徽标字体大小                                                                                                                                                                                                                  | number                                                                                          | 8            |
...
| badgePadding                  | 边徽标内边距                                                                                                                                                                                                                    | number &#124; number[]                                                                          | 0            |
