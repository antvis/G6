...
```bash
 npm install --save @antv/g6@5.0.0-beta.20
```
...
- 在  `{$version}` 中填写版本号，例如  `5.0.0-beta.20`；
...
<html lang="en">
  ...
  <body>
    ...
    /* 引入 G6 */
    <script src="https://gw.alipayobjects.com/os/lib/antv/g6/5.0.0-beta.20/dist/g6.min.js"></script>
