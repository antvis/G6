...
:::
> The above configuration works with original webpack project, if you using vue-cli and you should REMOVE the last config item `mode: 'production'` because of unnecessary.
