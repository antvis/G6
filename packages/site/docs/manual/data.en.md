...
- [getData](/en/api/graph#graphgetdata)
- [setData](/en/api/graph#graphsetdatadata)
- [getNodeData](/en/api/graph#graphgetnodedata)
- [getEdgeData](/en/api/graph#graphgetedgedata)
- [getComboData](/en/api/graph#graphgetcombodata)
- [addData](/en/api/graph#graphadddatadata)
- [addNodeData](/en/api/graph#graphaddnodedatadata)
- [addEdgeData](/en/api/graph#graphaddedgedatadata)
- [addComboData](/en/api/graph#graphaddcombodatadata)
- [updateData](/en/api/graph#graphupdatedatadata)
- [updateNodeData](/en/api/graph#graphupdatenodedatadata)
- [updateEdgeData](/en/api/graph#graphupdateedgedatadata)
- [updateComboData](/en/api/graph#graphupdatecombodatadata)
- [removeData](/en/api/graph#graphremovedataids)
- [removeNodeData](/en/api/graph#graphremovenodedataids)
- [removeEdgeData](/en/api/graph#graphremoveedgedataids)
- [removeComboData](/en/api/graph#graphremovecombodataids)
