...
- [setData](/en/api/data#graphsetdatadata)
...
- [addData](/en/api/data#graphadddatadata)
- [addNodeData](/en/api/data#graphaddnodedatadata)
- [addEdgeData](/en/api/data#graphaddedgedatadata)
- [addComboData](/en/api/data#graphaddcombodatadata)
- [updateData](/en/api/data#graphupdatedatadata)
- [updateNodeData](/en/api/data#graphupdatenodedatadata)
- [updateEdgeData](/en/api/data#graphupdateedgedatadata)
- [updateComboData](/en/api/data#graphupdatecombodatadata)
- [removeData](/en/api/data#graphremovedataids)
- [removeNodeData](/en/api/data#graphremovenodedataids)
- [removeEdgeData](/en/api/data#graphremoveedgedataids)
- [removeComboData](/en/api/data#graphremovecombodataids)
