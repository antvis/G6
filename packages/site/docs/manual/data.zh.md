...
- [setData](/api/data#graphsetdatadata)
- [getNodeData](/api/data#graphgetnodedata)
- [getEdgeData](/api/data#graphgetedgedata)
- [getComboData](/api/data#graphgetcombodata)
- [addData](/api/data#graphadddatadata)
- [addNodeData](/api/data#graphaddnodedatadata)
- [addEdgeData](/api/data#graphaddedgedatadata)
- [addComboData](/api/data#graphaddcombodatadata)
- [updateData](/api/data#graphupdatedatadata)
- [updateNodeData](/api/data#graphupdatenodedatadata)
- [updateEdgeData](/api/data#graphupdateedgedatadata)
- [updateComboData](/api/data#graphupdatecombodatadata)
- [removeData](/api/data#graphremovedataids)
- [removeNodeData](/api/data#graphremovenodedataids)
- [removeEdgeData](/api/data#graphremoveedgedataids)
- [removeComboData](/api/data#graphremovecombodataids)
