...
[Overview - v5.0.0-beta.21](../../README.en.md) / [Modules](../../modules.en.md) / [item](../../modules/item.en.md) / SphereNode
...
[CustomNode3D](CustomNode3D.en.md).[lodLevels](CustomNode3D.en.md#lodstrategy)
...
• **themeStyles**: [`NodeShapeStyles`](../../shape/NodeShapeStyles.en.md)
