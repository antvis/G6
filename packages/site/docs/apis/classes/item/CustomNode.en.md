...
[Overview - v5.0.0-beta.14](../../README.en.md) / [Modules](../../modules.en.md) / [item](../../modules/item.en.md) / CustomNode
...
- **`CustomNode`**
  ...
  ↳ [`CircleNode`](CircleNode.en.md)

  ↳ [`RectNode`](RectNode.en.md)

  ↳ [`StarNode`](StarNode.en.md)

  ↳ [`HexagonNode`](HexagonNode.en.md)

  ↳ [`TriangleNode`](TriangleNode.en.md)

  ↳ [`EllipseNode`](EllipseNode.en.md)

  ↳ [`DonutNode`](DonutNode.en.md)

  ↳ [`DiamondNode`](DiamondNode.en.md)

  ↳ [`ModelRectNode`](ModelRectNode.en.md)
...
• **defaultStyles**: [`NodeShapeStyles`](../../interfaces/item/NodeShapeStyles.en.md) \| `ComboShapeStyles`
...
• **mergedStyles**: [`NodeShapeStyles`](../../interfaces/item/NodeShapeStyles.en.md) \| `ComboShapeStyles`
