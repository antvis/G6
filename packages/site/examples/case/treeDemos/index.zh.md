...
树图是指数据未嵌套结构的、不存在环路的数据结构展示的图。树图中，根节点没有父节点，其它节点有且仅有一个父节点。一般图与树图的区别详见 [一般图与树图介绍](/zh/docs/manual/middle/layout/graph-layout#简介)
...
结合文件树与点线图，能够很好地展示不同类型节点之间的嵌套、从属关系。支持拖拽子树改变结构、收起/展开子树、增加自节点等编辑功能。
