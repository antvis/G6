...
import { deconstructData, withHandleAUD } from '../../util/data';
 ...
 */
export const ValidateData = withHandleAUD(
  (data: GraphData, options = {}, graphCore?: GraphCore): GraphData => {
    ...
    if (graphCore) {
      const { nodes = [], combos = [] } = deconstructData({
