...
const create2DGraph = (
  ...
  const graph = new G6.Graph({
    ...
    node: (innerModel) => {
      ...
      if (degree > 40) labelShowLevel = -1;
      else if (degree > 20) labelShowLevel = 0;
      else if (degree > 10) labelShowLevel = 1;
      else if (degree > 5) labelShowLevel = 2;
      else if (degree > 2) labelShowLevel = 3;
      return {
        ...innerModel,
        data: {
