...
import ComboForceLayout2 from './component/combo-force-layout2';
...
import GForceLayout from './component/gforce-layout';
...
storiesOf('Layout', module)
  ...
  .add('combo force layout 2', () => <ComboForceLayout2 />)
  .add('Fruchterman worker layout', () => <FruchtermanWorker />)
  ...
  .add('gforce layout', () => <GForceLayout />)
