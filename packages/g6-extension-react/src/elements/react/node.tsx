...
import type { HTMLStyleProps } from '@antv/g6';
...
export class ReactNode extends HTML {
  ...
  protected getKeyStyle(attributes: Required<ReactNodeStyleProps>): GHTMLStyleProps {
    return { ...super.getKeyStyle(attributes), innerHTML: '' };
  }

  public connectedCallback() {
    super.connectedCallback();
    this.root = createRoot(this.getDomElement());
    const { component } = this.attributes as ReactNodeStyleProps;
  ...
  public attributeChangedCallback(name: any, oldValue: any, newValue: any) {
    if (name === 'component' && oldValue !== newValue) {
      this.root.render((this.attributes as ReactNodeStyleProps).component as unknown as IReactNode);
    }
  }
